				...
				<div class="col-xl-6">
					<div class="panel panel-inverse">
						...
						<div class="panel-body">
							<form action="?c=formGroup&m=doUpdate" method="POST">
								<input type="hidden" name="ip-code" value="<?= $formGroup['code'] ?>">
								<div class="form-floating">
								  	<input id="ip-code" class="form-control fs-15px" value="<?= $formGroup['code'] ?>" readonly disabled />
								  	<label for="ip-code" class="d-flex align-items-center fs-13px">Mã</label>
								</div>

								<div class="form-floating mt-1">
								  	<input name="ip-name" id="ip-name" class="form-control fs-15px" value="<?= $formGroup['name'] ?>"/>
								  	<label for="ip-name" class="d-flex align-items-center fs-13px">Tên</label>
								</div>

								<div class="form-floating mt-1">
								  	<input name="ip-description" id="ip-description" class="form-control fs-15px" value="<?= $formGroup['description'] ?>"/>
								...
								<a class="btn btn-danger mt-1" href="?c=formGroup&m=list">Danh sách</a>
							</form>
						</div>
					</div>
				</div>
