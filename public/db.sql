...
-- Dumping data for table joy_home.form_step: ~2 rows (approximately)
...
-- Dumping data for table joy_home.media: ~17 rows (approximately)
DELETE FROM `media`;
...
INSERT INTO `status` (`id`, `code`, `name`, `description`, `tbl_name`) VALUES
	...
	(14, 'finish', 'Hoàn thành', NULL, 'user_pack_form_step'),
